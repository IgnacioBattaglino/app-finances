...
- **Movimientos / transactions**: `pages/Movements.jsx` (mezcla transactions y contributions, incluidas las cuentas de ahorro) · `components/TransactionFormModal.jsx` · `lib/transactions.js`, `lib/movements.js` (`monthTotals`: los cinco renglones del mes, y el único lugar que decide qué es Invertido y qué es Ahorrado).
