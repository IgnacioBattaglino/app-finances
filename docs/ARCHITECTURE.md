...
| account_id | uuid FK → liquid_accounts | nullable = "sin cuenta", el mismo balde que en transactions. Se define al crear el plan y se puede cambiar al confirmar |
